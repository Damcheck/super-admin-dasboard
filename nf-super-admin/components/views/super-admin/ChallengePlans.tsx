...
const INITIAL_PLANS: ChallengePlan[] = [
  { id: "pl-1", name: "Naira 200K", currency: "NGN", accountSize: 200000, price: 25000, phase1Target: 10, phase2Target: 5, dailyDrawdown: 5, maxDrawdown: 10, minTradingDays: 4, maxDuration: 30, profitSplitTier1: 80, profitSplitTier2: 60, status: "active", purchasedCount: 312, popular: false },
  { id: "pl-2", name: "Naira 400K", currency: "NGN", accountSize: 400000, price: 45000, phase1Target: 10, phase2Target: 5, dailyDrawdown: 5, maxDrawdown: 10, minTradingDays: 4, maxDuration: 30, profitSplitTier1: 80, profitSplitTier2: 60, status: "active", purchasedCount: 541, popular: true },
  { id: "pl-3", name: "Naira 800K", currency: "NGN", accountSize: 800000, price: 85000, phase1Target: 10, phase2Target: 5, dailyDrawdown: 5, maxDrawdown: 10, minTradingDays: 4, maxDuration: 30, profitSplitTier1: 80, profitSplitTier2: 60, status: "active", purchasedCount: 218, popular: true },
  { id: "pl-4", name: "Dollar $5K", currency: "USD", accountSize: 5000, price: 50, phase1Target: 10, phase2Target: 5, dailyDrawdown: 5, maxDrawdown: 10, minTradingDays: 4, maxDuration: 30, profitSplitTier1: 80, profitSplitTier2: 60, status: "active", purchasedCount: 94, popular: false },
  { id: "pl-5", name: "Dollar $10K", currency: "USD", accountSize: 10000, price: 100, phase1Target: 10, phase2Target: 5, dailyDrawdown: 5, maxDrawdown: 10, minTradingDays: 4, maxDuration: 30, profitSplitTier1: 80, profitSplitTier2: 60, status: "active", purchasedCount: 77, popular: true },
  { id: "pl-6", name: "Dollar $25K", currency: "USD", accountSize: 25000, price: 199, phase1Target: 10, phase2Target: 5, dailyDrawdown: 5, maxDrawdown: 10, minTradingDays: 4, maxDuration: 30, profitSplitTier1: 80, profitSplitTier2: 60, status: "active", purchasedCount: 43, popular: false },
  { id: "pl-7", name: "Elite $100K", currency: "USD", accountSize: 100000, price: 599, phase1Target: 8, phase2Target: 4, dailyDrawdown: 4, maxDrawdown: 8, minTradingDays: 5, maxDuration: 45, profitSplitTier1: 85, profitSplitTier2: 70, status: "draft", purchasedCount: 0, popular: false },
];
...
export default function ChallengePlansView() {
  ...
  const formatPrice = (plan: ChallengePlan) => plan.currency === "NGN" ? `₦${plan.price.toLocaleString()}` : `$${plan.price}`;
