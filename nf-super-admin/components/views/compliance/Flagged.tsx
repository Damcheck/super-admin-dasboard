          ...
          <div key={account.id} className={cn("glass-card rounded-xl overflow-hidden border", account.risk === "HIGH" ? "border-[#ff4444]/30" : "border-[#ffbc7c]/20")}>
            <div className="px-5 py-4 flex items-start justify-between">
              ...
              <div className="flex items-center gap-2">
                <button onClick={() => setSelected(selected === account.id ? null : account.id)} className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-[rgba(0,255,204,0.2)] text-xs text-[#00ffcc] hover:bg-[#00ffcc]/05 transition-all">
                  <Eye size={12} /> Review
                </button>
