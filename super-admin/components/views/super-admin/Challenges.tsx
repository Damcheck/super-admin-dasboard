  ...
  return (
    <div className="page-fade space-y-5">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: "Total Managed Capital", value: "$4.2M", sub: "+12% vs last month", icon: DollarSign, color: "#00ffcc" },
          { label: "Active Challenges", value: "854", sub: "+5% growth rate", icon: Trophy, color: "#00ffcc" },
          { label: "Success Rate", value: "14.2%", sub: "Phase 1 pass rate", icon: CheckCircle, color: "#ffbc7c" },
          { label: "Payouts Pending", value: "$142K", sub: "80/20 split enabled", icon: XCircle, color: "#ff6b6b" },
        ].map((s, i) => (
